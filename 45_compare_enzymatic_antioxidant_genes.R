...
# .csv file recording all the genes that overlap between the enzymatic 
# antioxidant network genes and the DEGs from the current study.
#-------------------------------------------------------------------------------
...
brainControlAllResults <- CompareBterDEGsAndDmelGenes("brain", "C", a = "antioxidant")

brainControlTop50Results <- CompareBterDEGsAndDmelGenes("brain", "C", 50, a = "antioxidant")

brainControlTop100Results <- CompareBterDEGsAndDmelGenes("brain", "C", 100, a = "antioxidant")

brainControlTop200Results <- CompareBterDEGsAndDmelGenes("brain", "C", 200, a = "antioxidant")

brainControlTop300Results <- CompareBterDEGsAndDmelGenes("brain", "C", 300, a = "antioxidant")
# Not enough DEGs to calculate "top500".

brainRemovalAllResults <- CompareBterDEGsAndDmelGenes("brain", "R", a = "antioxidant")
...
fatBodyControlAllResults <- CompareBterDEGsAndDmelGenes("fatbody", "C", a = "antioxidant")

fatBodyControlTop50Results <- CompareBterDEGsAndDmelGenes("fatbody", "C", 50, a = "antioxidant")

fatBodyControlTop100Results <- CompareBterDEGsAndDmelGenes("fatbody", "C", 100, a = "antioxidant")

fatBodyControlTop200Results <- CompareBterDEGsAndDmelGenes("fatbody", "C", 200, a = "antioxidant")

fatBodyControlTop300Results <- CompareBterDEGsAndDmelGenes("fatbody", "C", 300, a = "antioxidant")

fatBodyControlTop500Results <- CompareBterDEGsAndDmelGenes("fatbody", "C", 500, a = "antioxidant")

fatBodyRemovalAllResults <- CompareBterDEGsAndDmelGenes("fatbody", "R", a = "antioxidant")

fatBodyRemovalTop50Results <- CompareBterDEGsAndDmelGenes("fatbody", "R", 50, a = "antioxidant")

fatBodyRemovalTop100Results <- CompareBterDEGsAndDmelGenes("fatbody", "R", 100, a = "antioxidant")

fatBodyRemovalTop200Results <- CompareBterDEGsAndDmelGenes("fatbody", "R", 200, a = "antioxidant")

fatBodyRemovalTop300Results <- CompareBterDEGsAndDmelGenes("fatbody", "R", 300, a = "antioxidant")
# Not enough DEGs to calculate "top500".
...
ovariesControlAllResults <- CompareBterDEGsAndDmelGenes("ovaries", "C", a = "antioxidant")

ovariesControlTop50Results <- CompareBterDEGsAndDmelGenes("ovaries", "C", 50, a = "antioxidant")

ovariesControlTop100Results <- CompareBterDEGsAndDmelGenes("ovaries", "C", 100, a = "antioxidant")

ovariesControlTop200Results <- CompareBterDEGsAndDmelGenes("ovaries", "C", 200, a = "antioxidant")

ovariesControlTop300Results <- CompareBterDEGsAndDmelGenes("ovaries", "C", 300, a = "antioxidant")

ovariesControlTop500Results <- CompareBterDEGsAndDmelGenes("ovaries", "C", 500, a = "antioxidant")

ovariesRemovalAllResults <- CompareBterDEGsAndDmelGenes("ovaries", "R", a = "antioxidant")
# Not enough DEGs to calculate "top50" or higher.
...
write.csv(combinedStats, "36_NER0008751_obj1_table_S16_antioxidant_stats_results.csv",
          row.names = FALSE)

write.csv(combinedGenes, "37_NER0008751_obj1_table_S17_antioxidant_overlapping_genes.csv",
          row.names = FALSE)
